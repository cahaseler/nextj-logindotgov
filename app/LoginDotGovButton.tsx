...
export function LoginDotGovButton() {
  return (
    <button
      type="button"
      className="bg-white border border-gray-300 hover:bg-gray-100 text-gray-600 py-2 px-4 rounded inline-flex items-center"
      onClick={() => signIn("logindotgov")}
    >
